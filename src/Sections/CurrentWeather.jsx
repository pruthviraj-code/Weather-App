...
// import { getCityName } from "@/services/api";
...
//             {`      Berlin, Germany`}
//           </h2>
//           <p className="text-Neutral-200 mobile:text-[13px] mobile:text-start text-center text-[15px] xl:text-[20px]">
//             Tuesday, Aug 5, 2025
//           </p>
//         </div>
...
export default function CurrentWeather({}) {
  ...
  return (
    <div className="bg-Neutral-800 rounded-lg p-6">
      <h3 className="mb-4 text-lg font-semibold">Weather Details</h3>
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <div className="text-sm text-gray-400">Weather Code</div>
          <div className="text-xl font-semibold">
